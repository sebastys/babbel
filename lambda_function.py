...
def lambda_handler(event, context):
    try:
        ...
        for record in event['Records']:
            ...
            created_datetime = datetime.utcnow().isoformat() # Current UTC time
            event_type = 'enriched' # Example of additional field
            event_subtype = 'new' # Example of additional field
            ...
            s3_client.put_object(
                ...
                Bucket='example-s3-bucket', # Update with your S3 bucket name
                Key=f'{event_type}/{event_uuid}.json' # Update with desired S3 object key
            )
